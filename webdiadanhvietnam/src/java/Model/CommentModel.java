...
public class CommentModel {
    ...
    public void addComment(long post_id, long user_id, String comment_content) throws SQLException {
        try {
            String sqlStr = "INSERT INTO comment(post_id, user_id, comment_content, comment_date, comment_status) VALUES (?,?,?,NOW(),0)";
            this.pst = this.conn.prepareStatement(sqlStr);
